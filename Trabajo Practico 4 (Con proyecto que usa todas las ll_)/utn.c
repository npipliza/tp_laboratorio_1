...
int getInt1(int* numero,char* mensaje,char* mensajeError,int minimo,int reintentos)
{
    ...
    if(numero!=NULL && mensaje!= NULL && mensajeError!= NULL &&reintentos>=0)
    {
        ...
        {
            printf("\n%s",mensaje);
            if(getInt(&auxiliarResultado)&&(auxiliarResultado>=minimo))
            {
...
int getIntConMax(int* numero,char* mensaje,char* mensajeError,int minimo,int maximo,int reintentos)
{
    ...
    if(numero!=NULL && mensaje!= NULL && mensajeError!= NULL &&reintentos>=0&&minimo<=maximo)
    {
        ...
        {
            printf("\n%s",mensaje);
            if(getInt(&auxiliarResultado)&&(auxiliarResultado>=minimo)&&(auxiliarResultado<=maximo))
            {
                *numero=auxiliarResultado;
                validacion=1;
                break;
