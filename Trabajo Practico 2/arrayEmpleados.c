...
eEmpleados cargarDatosEmpleado(void)
{
    ...
    getFloatNew(auxiliar.salario,"Ingrese salario del empleado: ","ERROR. Ingrese salario del empleado: ");
	...
	do//creo bucle del menu
	{
		...
		switch(mostrarOpciones)
		{
			...
			case 3:
				...
				ValidarNumero(auxiliar.salario,"Ingrese salario del empleado: ","ERROR. Ingrese salario del empleado: ");
			break;
